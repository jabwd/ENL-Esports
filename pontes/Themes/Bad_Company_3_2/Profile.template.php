...
function template_showPosts()
{
	...
	if ((isset($context['attachments']) && empty($context['attachments'])) || (!isset($context['attachments']) && empty($context['posts'])))
		echo '
				<tr>
					<td class="tborder windowbg2 padding centertext first_td" colspan="4">
...
function template_trackIP()
{
	...
	else
	{
		...
		foreach ($context['ips'] as $ip => $memberlist)
			echo '
				<tr>
					<td class="windowbg2 first_td"><a href="', $context['base_url'], ';searchip=', $ip, '">', $ip, '</a></td>
	...
	else
	{
		...
		if (!empty($context['member']['permissions']['general']))
		{
			...
			foreach ($context['member']['permissions']['general'] as $permission)
			{
				echo '
							<tr>
								<td class="windowbg first_td" title="', $permission['id'], '">
